 ...
 * @package PhpGedView
 * @subpackage Themes
 * @version $Id: theme.php,v 1.2 2006/01/09 00:46:28 skenow Exp $
 */
...
$bwidth = 200;            // -- width of boxes on pedigree chart
$bheight = 78;            // -- height of boxes on pedigree chart
$baseyoffset = -90;       // -- position the entire pedigree tree relative to the top of the page
$basexoffset = 90;        // -- position the entire pedigree tree relative to the left of the page
