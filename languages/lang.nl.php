...
$pgv_lang["upload_help"]			= "Kies een bestand op de lokale schijf om naar de server te sturen. Het bestand zal daar worden geplaatst in de map: ";
...
$pgv_lang["register_info_01"]		= "De gegevens op deze website zijn mogelijk niet volledig toegankelijk voor alle bezoekers.<br /><br />Dit is een gevolg van de wet op gegevensbescherming en privacy.<br />U zult zich voor kunnen stellen dat sommige mensen het er niet mee eens zijn dat hun gegevens door iedereen ingezien kunnen worden, of kunnen worden misbruikt voor spam of commerciële doeleinden.<br /><br />Maar u heeft de mogelijkheid om u te registreren, om toegang tot de verborgen gegevens te krijgen, nadat de beheerder uw persoonlijke details heeft gecontroleerd. Indien de relatieprivacy is geactiveerd, heeft u toegang tot de informatie van uw directe relaties, na registratie. De beheerder kan u toegang verlenen om de gegevens van het bestand aan te passen, zodat u persoonlijke informatie kunt aanpassen, of toevoegen.<br /><br />OPMERKING: U zult alleen dan toegang tot de verborgen informatie krijgen, indien u aan kunt tonen dat u in het bestand voorkomt, of u een nauwe verwantschap heeft met een persoon in het bestand.<br /><br />In alle andere gevallen kunt u zich de moeite en tijd besparen om een gebruikersnaam aan te vragen. Als u meer ondersteuning nodig heeft, gebruik dan a.u.b. de koppeling onderaan om contact op te nemen met de beheerder.<br /><br />";
...
$pgv_lang["pls_note02"]				= "Opmerking: Wachtwoorden mogen letters, cijfers en andere karakters bevatten.";
...
$pgv_lang["recent_changes_block"]	= "Vak \"Recente wijzigingen\"";
...
$pgv_lang["user_messages_block"]	= "Vak \"Mijn berichten\"";
...
$pgv_lang["welcome_block"]			= "Vak \"Welkom ......\"";
...
$pgv_lang["gedcom_block"]			= "Het \"GEDCOM welkom\" vak";
...
$pgv_lang["user_favorites_block"]	= "Vak \"Favorieten gebruiker\"";
$pgv_lang["random_media_block"]		= "Vak \"Willekeurige afbeelding\"";
$pgv_lang["gedcom_favorites_block"]	= "Vak \"GEDCOM-favorieten\"";
...
$pgv_lang["gedcom_stats_block"]		= "Vak \"GEDCOM-statistieken\"";
...
$pgv_lang["theme_select_block"]		= "Vak \"Selecteer een thema\"";
...
$pgv_lang["block_top10"]			= "Vak \"Achternamen Top 10\"";
...
$pgv_lang["user_news_block"]		= "Vak \"Gebruikers notitieblok\"";
...
$pgv_lang["add_main_block"] 		= "Vak toevoegen aan linker sectie...";
$pgv_lang["add_right_block"]		= "Vak toevoegen aan rechter sectie...";
...
$pgv_lang["todays_events_block"]	= "Vak \"Op deze dag, in het verleden....\"";
$pgv_lang["logged_in_users_block"]	= "Vak \"Aangemelde gebruikers\"";
...
$pgv_lang["upcoming_events_block"]	= "Vak \"Binnenkort...\"";
...
$pgv_lang["privacy_write_error"]	= "FOUT!!! Kan niet schrijven naar het [#PRIVACY_MODULE#] bestand.<br />Overtuig u ervan dat de schrijfbevoegdheden voor dit bestand zijn ingesteld.<br />De bevoegdheden kunnen eventueel weer worden hersteld nadat het privacybestand is geschreven.";
...
$pgv_lang["top10_pageviews_block"]		= "Vak \"Meest bekeken gegevens\"";
...
$pgv_lang["review_changes_block"]	= "Vak \"Te beoordelen wijzigingen\"";
